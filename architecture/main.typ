...
image("assets/strip_winding_numbers.pdf", width: 85%),
    caption: [Calculating winding numbers of each pixel in a strip. We first calculate the winding number for each tile, and then sum the result to calculate the total winding number of each pixel in the whole tile area. Red areas represent the trapezoid spanned by the line.],
