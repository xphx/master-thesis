...
The answer depends on the _opacity_ (also known as alpha value) of the color. In @colors, it was mentioned that a color is specified by the three components red, green and blue. In reality, there usually is a fourth component that is called _alpha_. The alpha value specifies how transparent the color should be. If the value is 0.0 (0%) it means that the color is completely _transparent_, i.e. completely invisible. If the value is 1.0 (100%), the color is completely _opaque_, i.e. completely visible. By choosing a value between 0.0 and 1.0, we can make a color semi-transparent. Similarly to colors, we can also specify opacity using values between 0 and 255 instead. We use the term _RGBA_ to denote storing RGB colors with an additional alpha channel.
