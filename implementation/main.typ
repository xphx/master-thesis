...
== Packing <packing>
After completing fine rasterization, each wide tile stores a buffer of RGBA values for each pixel that is covered by the wide tile. However, there are four problems that need to be addressed:
